...
$sql = "SELECT curso.ID_curso, curso.nombre, curso.archivo 
        FROM progreso 
        JOIN curso ON progreso.ID_curso = curso.ID_curso 
        WHERE progreso.ID_estudiante = ? AND progreso.porcentaje_completado < 100";
...
<br><br><br><br><br><br>
    <div class="miscursos">
        ...
        <div class="botones">
            <a href="mis_cursos_proceso.php" class="btnTerminados">Cursos en proceso</a>
            <a href="mis_cursos.php" class="btnEnProceso">Cursos terminados</a>
        </div>
    </div>
    ...
    <?php while ($curso = $result->fetch_assoc()): ?>
        <div class="curso">
            ...
            <img src="<?php echo 'img/' . htmlspecialchars($curso['archivo']); ?>" alt="Imagen del curso">
            <a href="continuar_curso.php?id_curso=<?php echo urlencode($curso['ID_curso']); ?>">
                <button>Continuar progreso</button>
            </a>
        </div>
    <?php endwhile; ?>
    </div>
